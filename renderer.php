...
/**
 * Interactive MooPT behaviour renderer.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbehaviour_interactivemoopt_renderer extends qbehaviour_renderer {
    ...
    public function feedback(question_attempt $qa, question_display_options $options) {
        ...
        if (!$qa->get_state()->is_active() ||
                ($options->readonly !== qbehaviour_interactivemoopt::TRY_AGAIN_VISIBLE &&
                        $options->readonly !== qbehaviour_interactivemoopt::TRY_AGAIN_VISIBLE_READONLY)) {
            return '';
        }
        ...
        $attributes = array(
            ...
            'value' => get_string('tryagain', 'qbehaviour_interactivemoopt'),
            'class' => 'submit btn btn-secondary',
        );
        if ($options->readonly === qbehaviour_interactivemoopt::TRY_AGAIN_VISIBLE_READONLY) {
