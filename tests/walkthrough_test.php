...
namespace qbehaviour_interactivemoopt;
...
/**
 * Unit tests for the MooPT interactive behaviour.
 *
...
class walkthrough_test extends \qbehaviour_walkthrough_test_base {
    ...
    public function test_interactivemoopt_feedback_multichoice_right() {
    ...
    public function test_interactivemoopt_finish_when_try_again_showing() {
    ...
    public function test_interactivemoopt_shortanswer_try_to_submit_blank() {
    ...
    public function test_interactivemoopt_feedback_multichoice_multiple_reset() {
    ...
    public function test_interactivemoopt_regrade_changing_num_tries_leaving_open() {
        // Create a multichoice multiple question.
    ...
    public function test_interactivemoopt_regrade_changing_num_tries_finished() {
        // Create a multichoice multiple question.
        $q = \test_question_maker::make_question('shortanswer');
        $q->hints = array(
            new question_hint_with_parts(0, 'This is the first hint.', FORMAT_HTML, true, true),
    ...
    public function test_review_of_interactivemoopt_questions_before_finished() {
        // Create a multichoice multiple question.
        $q = \test_question_maker::make_question('shortanswer');
        $q->hints = array(
                new question_hint_with_parts(0, 'This is the first hint.', FORMAT_HTML, true, true),
